...
/* res_search_async from OpenBSD 7.0 source code: lib/libc/asr/res_search_async.c */
 ...
 */
struct asr_query *__res_search_async(const char *name, int class, int type, void *asr)
{
	struct asr_ctx *ac;
	struct asr_query *as;
...
weak_alias(__res_search_async, res_search_async);

struct asr_query *_res_search_async_ctx(const char *name, int class, int type, struct asr_ctx *ac)
{
	struct asr_query *as;
...
static int res_search_async_run(struct asr_query *as, struct asr_result *ar)
{
	int r;
	char fqdn[MAXDNAME];
 ...
 */
static size_t domcat(const char *name, const char *domain, char *buf, size_t buflen)
{
	size_t r;
 ...
 */
int _asr_iter_domain(struct asr_query *as, const char *name, char * buf, size_t len)
{
	const char *c;
	int dots;
