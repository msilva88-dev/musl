...
/* getrrsetbyname from OpenBSD 7.0 source code: lib/libc/asr/getrrsetbyname.c */
...
int getrrsetbyname(const char *name, unsigned int class, unsigned int type,
...
weak_alias(__freerrset, freerrset);
