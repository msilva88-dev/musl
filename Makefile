...
LINUX_HEADERS = sys/epoll.h sys/eventfd.h sys/fanotify.h sys/inotify.h
LINUX_HEADERS += sys/personality.h sys/random.h sys/sysinfo.h sys/timex.h sys/xattr.h
