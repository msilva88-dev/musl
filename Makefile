...
GENH = $(objbuilddir)/include/bits/alltypes.h
GENH += $(objbuilddir)/include/bits/syscall.h
...
$(objbuilddir)/include/bits/syscall.h: \
  $(srcdir)/arch/$(ARCH)/bits/syscall.h.in
	cp $(@:$(objbuilddir)/include/%=$(srcdir)/arch/$(ARCH)/%.in) $@
	sed -n -e s/__NR_/SYS_/p < $(@:$(objbuilddir)/include/%=$(srcdir)/arch/$(ARCH)/%.in) \
	  >> $@
...
CC_ACRT = $(CC) $(CFLAGS_ALL) -DCRT -c -o
CC_CMD = $(CC) $(CFLAGS_ALL) -c -o
CC_CRT = $(CC) $(CFLAGS_ALL) -DCRT $(CFLAGS_NOSSP) -c -o
CC_LDSO = $(CC) $(CFLAGS_ALL) -fPIC $(CFLAGS_NOSSP) -c -o
CC_LIB = $(CC) $(CFLAGS_ALL) $(CFLAGS_NOSSP) -c -o
CC_LMEM = $(CC) $(CFLAGS_ALL) -O3 $(CFLAGS_MEMOPS) $(CFLAGS_NOSSP) -c -o
CC_MEM = $(CC) $(CFLAGS_ALL) -O3 $(CFLAGS_MEMOPS) -c -o
CC_OCMD = $(CC) $(CFLAGS_ALL) -O3 -c -o
CC_OPIC = $(CC) $(CFLAGS_ALL) -O3 -fPIC -c -o
CC_PIC = $(CC) $(CFLAGS_ALL) -fPIC -c -o
CC_PCRT = $(CC) $(CFLAGS_ALL) -fPIC -DCRT $(CFLAGS_NOSSP) -c -o
AS_CMD = $(CC) $(CFLAGS_ALL) -x assembler -c -o
AS_CRT = $(CC) $(CFLAGS_ALL) -DCRT -x assembler -c -o
AWK_CMD = LC_ALL=C awk -f $(srcdir)/tools/add-cfi.common.awk
AWK_CMD += -f $(srcdir)/tools/add-cfi.$(ARCH).awk

$(objbuilddir)/crt/$(ARCH)/crti.o: $(srcdir)/crt/$(ARCH)/crti.s
	@if [ "$(ADD_CFI)" = "yes" ]; then $(AWK_CMD) $(@:$(objbuilddir)/%.o=$(srcdir)/%.s) | $(AS_CRT) $@ -; \
	else $(CC_ACRT) $@ $(@:$(objbuilddir)/%.o=$(srcdir)/%.s); fi
$(objbuilddir)/crt/$(ARCH)/crtn.o: $(srcdir)/crt/$(ARCH)/crtn.s
	@if [ "$(ADD_CFI)" = "yes" ]; then $(AWK_CMD) $(@:$(objbuilddir)/%.o=$(srcdir)/%.s) | $(AS_CRT) $@ -; \
	else $(CC_ACRT) $@ $(@:$(objbuilddir)/%.o=$(srcdir)/%.s); fi
$(objbuilddir)/src/fenv/aarch64/fenv.o: $(srcdir)/src/fenv/aarch64/fenv.s
	@if [ "$(ADD_CFI)" = "yes" ]; then $(AWK_CMD) $(@:$(objbuilddir)/%.o=$(srcdir)/%.s) | $(AS_CMD) $@ -; \
	else $(CC_CMD) $@ $(@:$(objbuilddir)/%.o=$(srcdir)/%.s); fi
...
$(objbuilddir)/crt/Scrt1.o: $(srcdir)/crt/Scrt1.c $(GENH) $(IMPH)
	$(CC_PCRT) $@ $(@:$(objbuilddir)/%.o=$(srcdir)/%.c)
$(objbuilddir)/crt/crt1.o: $(srcdir)/crt/crt1.c $(GENH) $(IMPH)
	$(CC_CRT) $@ $(@:$(objbuilddir)/%.o=$(srcdir)/%.c)
...
$(objbuilddir)/src/internal/sh/__shcall.o: $(srcdir)/src/internal/sh/__shcall.c \
  $(GENH) $(IMPH)
	$(CC_OCMD) $@ $(@:$(objbuilddir)/%.o=$(srcdir)/%.c)
...
$(objbuilddir)/crt/$(ARCH)/crti.lo: $(srcdir)/crt/$(ARCH)/crti.s
	@if [ "$(ADD_CFI)" = "yes" ]; then $(AWK_CMD) $(@:$(objbuilddir)/%.lo=$(srcdir)/%.s) | $(AS_CRT) $@ -; \
	else $(CC_ACRT) $@ $(@:$(objbuilddir)/%.lo=$(srcdir)/%.s); fi
$(objbuilddir)/crt/$(ARCH)/crtn.lo: $(srcdir)/crt/$(ARCH)/crtn.s
	@if [ "$(ADD_CFI)" = "yes" ]; then $(AWK_CMD) $(@:$(objbuilddir)/%.lo=$(srcdir)/%.s) | $(AS_CRT) $@ -; \
	else $(CC_ACRT) $@ $(@:$(objbuilddir)/%.lo=$(srcdir)/%.s); fi
$(objbuilddir)/src/fenv/aarch64/fenv.lo: $(srcdir)/src/fenv/aarch64/fenv.s
	@if [ "$(ADD_CFI)" = "yes" ]; then $(AWK_CMD) $(@:$(objbuilddir)/%.lo=$(srcdir)/%.s) | $(AS_CMD) $@ -; \
	else $(CC_CMD) $@ $(@:$(objbuilddir)/%.lo=$(srcdir)/%.s); fi
...
$(objbuilddir)/src/fenv/arm/fenv-hf.lo: $(srcdir)/src/fenv/arm/fenv-hf.S
	$(CC_CMD) $@ $(@:$(objbuilddir)/%.lo=$(srcdir)/%.S)
...
$(objbuilddir)/compat/time32/__xstat.lo: $(srcdir)/compat/time32/__xstat.c $(GENH) $(IMPH)
	$(CC_PIC) $@ $(@:$(objbuilddir)/%.lo=$(srcdir)/%.c)
...
$(objbuilddir)/crt/Scrt1.lo: $(srcdir)/crt/Scrt1.c $(GENH) $(IMPH)
	$(CC_PCRT) $@ $(@:$(objbuilddir)/%.lo=$(srcdir)/%.c)
$(objbuilddir)/crt/crt1.lo: $(srcdir)/crt/crt1.c $(GENH) $(IMPH)
	$(CC_CRT) $@ $(@:$(objbuilddir)/%.lo=$(srcdir)/%.c)
...
$(objbuilddir)/ldso/dlstart.lo: $(srcdir)/ldso/dlstart.c $(GENH) $(IMPH)
	$(CC_LDSO) $@ $(@:$(objbuilddir)/%.lo=$(srcdir)/%.c)
...
$(objbuilddir)/src/internal/sh/__shcall.lo: $(srcdir)/src/internal/sh/__shcall.c \
  $(GENH) $(IMPH)
	$(CC_OPIC) $@ $(@:$(objbuilddir)/%.lo=$(srcdir)/%.c)
...
$(libbuilddir)/musl-gcc.specs: $(srcdir)/tools/musl-gcc.specs.sh config.mak
	sh $(@:$(libbuilddir)/%=$(srcdir)/tools/%.sh) "$(includedir)" "$(libdir)" "$(LDSO_PATHNAME)" > $@
...
$(DESTDIR)$(includedir)/bits/alltypes.h.in: \
  $(srcdir)/arch/$(ARCH)/bits/alltypes.h.in
	mkdir -p $$(dirname $@) 2>/dev/null || true
	cp $(@:$(DESTDIR)$(includedir)/%=$(srcdir)/arch/$(ARCH)/%) $@ && chmod 644 $@
...
$(DESTDIR)$(includedir)/bits/dirent.h: $(srcdir)/arch/generic/bits/dirent.h
	mkdir -p $$(dirname $@) 2>/dev/null || true
	cp $(@:$(DESTDIR)$(includedir)/%=$(srcdir)/arch/generic/%) $@ && chmod 644 $@
...
$(DESTDIR)$(includedir)/bits/alltypes.h: $(objbuilddir)/include/bits/alltypes.h
	mkdir -p $$(dirname $@) 2>/dev/null || true
	cp $(@:$(DESTDIR)$(includedir)/%=$(objbuilddir)/include/%) $@ && chmod 644 $@
...
$(DESTDIR)$(includedir)/aio.h: $(srcdir)/include/aio.h
	mkdir -p $$(dirname $@) 2>/dev/null || true
	cp $(@:$(DESTDIR)$(includedir)/%=$(srcdir)/include/%) $@ && chmod 644 $@
