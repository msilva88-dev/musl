...
/* ber header from OpenBSD 7.0 source code: lib/libutil/ber.h */
...
void ober_set_header(struct ber_element *, int, unsigned int);
void ober_link_elements(struct ber_element *, struct ber_element *);
struct ber_element *ober_unlink_elements(struct ber_element *);
void ober_replace_elements(struct ber_element *, struct ber_element *);
...
int ober_get_nstring(struct ber_element *, void **, size_t *);
int ober_get_ostring(struct ber_element *, struct ber_octetstring *);
struct ber_element *ober_add_bitstring(struct ber_element *, const void *,
	size_t);
int ober_get_bitstring(struct ber_element *, void **, size_t *);
...
struct ber_element *ober_add_noid(struct ber_element *, struct ber_oid *,
	int);
...
void ober_set_writecallback(struct ber_element *, void (*)(void *, size_t),
	void *);
